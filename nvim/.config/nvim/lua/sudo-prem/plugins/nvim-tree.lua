  ...
  config = function()
    ...
    require("nvim-tree").setup ({
      on_attach = function (bufnr)
        ...
        vim.keymap.set("n", "l", function() api.node.open.edit() end, opts )
        vim.keymap.set("n", "i", function() api.node.show_info_popup() end, opts )
        vim.keymap.set("n", ".", function() api.tree.change_root_to_node() end, opts )
      end,
      view = {
        debounce_delay = 10,
        side = "right",
