local M = {
  ...
  f = { require("premnaath.core.utils").telescope_git_or_file, "Find Files (Root)" },
  ...
  u = {
    name = "UI",
    v = { require("premnaath.core.utils").toggle_set_color_column, "Toggle Color Line" },
    c = { require("premnaath.core.utils").toggle_cursor_line, "Toggle Cursor Line" },
  },
  i = {
    name = "Sessions",
  ...
  l = {
    ...
    c = { require("premnaath.core.utils").copyFilePathAndLineNumber, "Copy File Path and Line Number" },
